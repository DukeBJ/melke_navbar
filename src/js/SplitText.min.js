...
!(function (t) {
    ...
    var e = t.GreenSockGlobals || t,
        ...
        h = (function (e) { return true;
            for (
                var i = -1 !== (t ? t.location.href : "").indexOf(String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107)) && -1 !== e.indexOf(String.fromCharCode(108, 111, 99, 97, 108, 104, 111, 115, 116)),
                    n = [
                        s,
        ...
        p = function (t) {
            var e,
                ...
                o = t.length;
            for (e = 0; o > e; e++)
                if (((i = t[e]), g(i))) for (n = i.length, n = 0; n < i.length; n++) r.push(i[n]);
                else r.push(i);
            return r;
        },
        _ = /(?:\r|\n|\t\t)/g,
        ...
        T = (n.SplitText = e.SplitText = function (e, i) {
            ...
            return h
                ? ((this.elements = g(e) ? p(e) : [e]), (this.chars = []), (this.words = []), (this.lines = []), (this._originals = []), (this.vars = i || {}), void this.split(i))
                : ((t.location.href = "http://" + s + a + "?plugin=" + o + "&source=" + r), !1);
        }),
        D = function (t, e, i) {
            var n = t.nodeType;
            if (1 === n || 9 === n || 11 === n) for (t = t.firstChild; t; t = t.nextSibling) D(t, e, i);
        ...
        O = function (t, e, i, n, r, o, s) {
            ...
            if (I || j)
                for (a = 0; l > a; a++)
                    (f = g[a]),
                        ...
                        (p || j || (B && !X)) &&
                            ((y = f.offsetTop),
                            I && p && Math.abs(y - x) > T && "BR" !== f.nodeName && ((_ = []), I.push(_), (x = y)),
                            j && ((f._x = f.offsetLeft), (f._y = y), (f._w = f.offsetWidth), (f._h = f.offsetHeight)),
                            I &&
                                (((f._isSplit && p) || (!B && p) || (X && p) || (!X && f.parentNode.parentNode === t && !f.parentNode._isSplit)) && (_.push(f), (f._x -= w), R(f, t, V) && (f._wordEnd = !0)),
                                "BR" === f.nodeName && f.nextSibling && "BR" === f.nextSibling.nodeName && I.push([])));
            for (a = 0; l > a; a++)
                (f = g[a]),
                    (p = f.parentNode === t),
                    "BR" !== f.nodeName
                        ? (j &&
                              ((C = f.style),
                              X || p || ((f._x += f.parentNode._x), (f._y += f.parentNode._y)),
                              (C.left = f._x + "px"),
                              (C.top = f._y + "px"),
                              (C.position = "absolute"),
                              (C.display = "block"),
                          ...
                          !X && B
                              ? f._isSplit
                                  ...
                                  ? ((f._parent = f.parentNode),
                                    ...
                                    l--)
                                  : p ||
                                    ((y = !f.nextSibling && R(f.parentNode, t, V)),
                                    f.parentNode._parent && f.parentNode._parent.appendChild(f),
                                    y && f.parentNode.appendChild(c.createTextNode(" ")),
                                    e.span && (f.style.display = "inline"),
                                    O.push(f))
                              : f.parentNode._isSplit && !f._isSplit && "" !== f.innerHTML
                              ? H.push(f)
                              : B && !f._isSplit && (e.span && (f.style.display = "inline"), O.push(f)))
                        : I || j
                        ? (f.parentNode && f.parentNode.removeChild(f), g.splice(a--, 1), l--)
                        : X || t.appendChild(f);
            ...
            if (I) {
                ...
                for (m = " " === V && (!j || (!X && !B)), a = 0; a < I.length; a++) {
                    for (
                        _ = I[a], v = c.createElement(z), v.style.cssText = "display:block;text-align:" + E + ";position:" + (j ? "absolute;" : "relative;"), F && (v.className = F + (Y ? a + 1 : "")), q.push(v), l = _.length, h = 0;
                        l > h;
                        h++
                    )
                        "BR" !== _[h].nodeName &&
                            ((f = _[h]),
                            v.appendChild(f),
                            m && f._wordEnd && v.appendChild(c.createTextNode(" ")),
                            j && (0 === h && ((v.style.top = f._y + "px"), (v.style.left = w + y + "px")), (f.style.top = "0px"), y && (f.style.left = f._x - y + "px")));
                    0 === l ? (v.innerHTML = "&nbsp;") : X || B || (L(v), D(v, String.fromCharCode(160), " ")), j && ((v.style.width = S), (v.style.height = f._h + "px")), t.appendChild(v);
                }
                t.style.cssText = C;
            }
            j && (s > t.clientHeight && ((t.style.height = s - P + "px"), t.clientHeight < s && (t.style.height = s + M + "px")), o > t.clientWidth && ((t.style.width = o - k + "px"), t.clientWidth < o && (t.style.width = o + A + "px"))),
                N(i, O),
                N(n, H),
                N(r, q);
        },
        H = function (t, e, i, n) {
            ...
            for (
                L.insertBefore(R, t),
                    ...
                    r = l(t),
                    f = -1 !== r.indexOf("<"),
                    e.reduceWhiteSpace !== !1 && (r = r.replace(m, " ").replace(_, "")),
                    f && (r = r.split("<").join("{{LT}}")),
                    h = r.length,
                    o = (" " === r.charAt(0) ? T : "") + i(),
                    s = 0;
                ...
                if (((d = r.charAt(s)), d === k && r.charAt(s - 1) !== k && s)) {
                    ...
                    "{" === d && "{{LT}}" === r.substr(s, 6)
                        ? ((o += A ? n() + "{{LT}}</" + p + ">" : "{{LT}}"), (s += 5))
                        : (d.charCodeAt(0) >= C && d.charCodeAt(0) <= v) || (r.charCodeAt(s + 1) >= 65024 && r.charCodeAt(s + 1) <= 65039)
                        ? ((u = M(r.substr(s, 2))),
                          (g = M(r.substr(s + 2, 2))),
                          (a = (y > u || u > b || y > g || g > b) && (w > g || g > x) ? 2 : 4),
                          (o += A && " " !== d ? n() + r.substr(s, a) + "</" + p + ">" : r.substr(s, a)),
                          (s += a - 1))
                        : (o += A && " " !== d ? n() + d + "</" + p + ">" : d);
                ...
                for (e.absolute = !1, r = 0; a > r; r++)
                    (o = s[r]),
                        (3 !== o.nodeType || /\S+/.test(o.nodeValue)) &&
                            (h && 3 !== o.nodeType && "inline" === u(o, "display", null, !0) && ((o.style.display = "inline-block"), (o.style.position = "relative")), (o._isSplit = !0), q(o, e, i, n));
